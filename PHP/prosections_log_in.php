	...
	if(empty($_POST) === false) {
		...
		if(empty($username) === true || empty($password) === true) {
			...
			if($login === false) {
				...
				$_SESSION['user_id_prosections'] = $login;
				
				// redirect the user to the homepage
				header('Location: prosections_homepage.php');
				exit();
			}
		}
...
<head>
    ...
    <title>Login - Prosections - UCC Donor Program</title>
...
?>	
	...
	<div class="container">
		<h1>Prosections Login</h1>
		
		<form role="form" action='prosections_log_in.php' method='POST' class="form" id="sign_in_form">

					<input class="input_box input_box_prosections" placeholder="E-mail address" name="username" type="email" id="inputEmail"  required>

					<input class="input_box input_box_prosections" placeholder="Password" name="password" type="password" id="inputPassword" required>
				...
				<div>
					<button type="submit" id="login-button-orange">Sign in</button>
				</div>
