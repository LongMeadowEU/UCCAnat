...
// array lists for the SPECIFIC REGIONS selection box values		
	...
	var specific_gu_pelvis_with_viscera_regions = [
	  ...
	  {display: "Penis", value: "gu_pelvis_with_viscera_penis"},
	  {display: "Dissected Penis", value: "gu_pelvis_with_viscera_dissected_penis"},
	  {display: "Dissected Testis", value: "gu_pelvis_with_viscera_dissected_testis"},
	  ...
	  {display: "Uterine Artery", value: "gu_pelvis_with_viscera_uterine_artery"},
	  {display: "Uterus", value: "gu_pelvis_with_viscera_uterus"}, 
	  {display: "Clitoris", value: "gu_pelvis_with_viscera_clitoris"}, 
	...
	var specific_gu_pelvic_organs_regions = [
	  ...
	  {display: "Uterus with Ovaries", value: "gu_pelvic_organs_uterus_with_ovaries"}
    ];
...
// ************************************************************************************************************************************************************//
//function to populate child select box >> FOR THE REGION SELECT BOX
...
// Change function: populate the specific region select box when basic region select box option is chosen
$("#prosection_region_4").change(function() {
    var parent_1 = $(this).val(); 
	//console.log($("#prosection_region").val());
    switch(parent_1){ 
        case 'ul_shoulder':
