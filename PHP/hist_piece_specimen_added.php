...
<head>
    ...
    <title>Add A Historical Piece - Complete</title>
            ...
            <div class="container-fluid">
                	...
                	<div id="border-under-header">
                          <div class="row" id="welcomePageMainDiv">
                               <div class="col-lg-10">
                                  <h2 class="page-header" id="homepageHeader">Add a Historical Piece - Complete</h2>
                                  <ol class="breadcrumb">
                                      <li>
										<a href="historical_pieces_home.php">Home</a>
                                      </li>
                                      <li class="active">
                                          <a href="#"><strong>Add a Historical Piece - Complete</strong></a>
                                      </li>
                                  </ol>
                               </div><!-- /.col-lg-10 -->
                              </div><!-- /.row -->
									...
									<div class="row" style="margin-left: auto; margin-right:auto; display:block;">
										<div class="col-lg-6 col-md-offset-3 add_patient_table">
                                        	<div class="form-group centred_text">
                                                <h3>Complete</h3><br/>
                                                <h4>The historical piece specimen has been successfully added to the database</h4><br/>
                                            
                                                <a href="historical_pieces_home.php">	
                                                    <button type="button" class="btn btn-lg btn-blue-new" value="homepage">Home</button>
                                                </a>
                                            </div>
                                        </div>		
									</div><!-- /.row -->
