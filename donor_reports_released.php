...
<head>
    ...
    <title>Donor Reports - Released in Year</title>
...
<body>
                          ...
                          <div class="row" id="welcomePageMainDiv">
                               <div class="col-lg-10">
                                  ...
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="active">
                                      	<a href="donor_reports_released.php"><strong>Donors Released in Year</strong></a>
                                      </li>
                                  </ol>
                               </div><!-- /.col-lg-10 -->
                              </div><!-- /.row -->
									...
									<div class="col-lg-4 col-md-offset-4">
                                      <form role="form" id="search_prosections" action="" method="POST">
                                          <div class="input-group custom-search-form" style="margin-top:15%">
                                              <input type="number" id="report_year_search_box" name="report_year_search_box" class="form-control" placeholder="Enter Year to Search - Donors Released">
	...
	function new_report_search() {
		window.location = "donor_reports_released.php";
	}
