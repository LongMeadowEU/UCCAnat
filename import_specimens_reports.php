        ...
        <div id="wrapper">
            ...
            if (empty($_POST) === false) {
                if ($_POST['report_year_search_box']) {
                    ...
                    $yearReportQ = "SELECT * FROM  import_specimens WHERE YEAR(specimen_delivery_date) LIKE '%$searched_year%' ";
                    $result_year = mysqli_query($db_connect, $yearReportQ) or die($connect_error1);
                                        ...
                                        <div class="dataTable_wrapper">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover sortable" id="donor_reports_table">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        while ($record = mysqli_fetch_assoc($result_year)) {
