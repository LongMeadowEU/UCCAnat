...
$result_auto_ref = mysqli_query($db_connect, "SELECT donor_reference_number FROM donor_table") or die($connect_error1);
//echo $result_auto_ref;
$array1 = array();

while ($record = mysqli_fetch_assoc($result_auto_ref)) {
            ...
            if ($_POST['submitGenInfo']) {
                if (empty($_POST['donor_reference_num']) === false) {
                    ...
                    if (!empty($_POST['other_religion'])) {
                        ...
                        mysqli_query("UPDATE donor_table SET other_religion = '$other_religion_1' WHERE donor_reference_number = '$donorIDsession'");
                    }
                }
            }
        }
