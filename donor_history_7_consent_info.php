...
if (empty($_POST) === false) {
    ...
    if ($_POST['save_new_info_pg_consent']) {
        ...
        if ($consent_part_1 == "consent_retained_3_years") {
            ...
            mysqli_query($db_connect, "UPDATE donor_table SET consent_part_1_3_years_options = '$consent_part_1_3_years_options' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        }
        ...
        mysqli_query($db_connect, "UPDATE donor_table SET consent_part_1 = '$consent_part_1' WHERE donor_reference_number = '$selected_donor_ref_hist'");

        mysqli_query($db_connect, "UPDATE donor_table SET consent_part_2 = '$consent_part_2' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET consent_withdrawn = '$consent_withdrawn' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET consent_withdrawl_date = '$consent_withdrawl_date' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET written_confirmation_of_withdrawal = '$written_confirmation_of_withdrawal' WHERE donor_reference_number = '$selected_donor_ref_hist'");
                                        ...
                                        <table id="genInfoFormTable" class="centred_text add_patient_table">
                                            ...
                                            <tr style="border:2px #1ab394 solid"> 
                                                ...
                                                <td class="formInputConsent"  align="left">
                                                    <div class="radio">
                                                        <?php
                                                        if ($consent_part_1_new == "consent_permanently_retained") {
                                                            echo '
                                                    ...
                                                    <div class="radio">
                                                        <?php
                                                        if ($consent_part_1_new == "consent_retained_3_years") {
                                                            echo '
                                            ...
                                            <tr id="consent_retained_3_years_checked" style="border:2px #1ab394 solid">
                                                ...
                                                <td class="formInputConsent"  align="left">
                                                    ...
                                                    <label class="radio">
                                                        <?php
                                                        if ($consent_part_1_3_years_options_new == "1") {
                                                            echo '
                                                    ...
                                                    <label class="radio">
                                                        <?php
                                                        if ($consent_part_1_3_years_options_new == "0") {
                                                            echo '
                                            ...
                                            <tr style="border:2px #9c31b8 solid"> 
                                                ...
                                                <td class="formInputConsent"  align="left">
                                                    <div class="radio">
                                                        <?php
                                                        if ($consent_part_2_new == "consent_images_yes") {
                                                            echo '
                                                    ...
                                                    <div class="radio">
                                                        <?php
                                                        if ($consent_part_2_new == "consent_images_no") {
                                                            echo '
                                                ...
                                                <td class="formInputConsent3"  align="left">
                                                    <div style="margin-left: 20%; width: 50%">
                                                        <div class="radio">
                                                            <label class="radio-inline">
                                                                <?php
                                                                if ($new_written_confirmation_of_withdrawal == "1") {
                                                            ...
                                                            <label class="radio-inline" style="margin-left: 70%">
<?php
if ($new_written_confirmation_of_withdrawal == "0") {
