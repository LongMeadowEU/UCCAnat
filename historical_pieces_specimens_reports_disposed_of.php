...
<head>
    ...
    <title>Historical Pieces Reports - Disposed Of</title>
...
<body>
	...
	<?php
		...
		if (empty($_POST) === false) {
			if($_POST['report_year_search_box']) {
				...
				$result_year = mysql_query("SELECT * FROM  historical_pieces_table WHERE YEAR(date_disposed_of) LIKE '%$searched_year%' ") or die($connect_error1);
                          ...
                          <div class="row" id="welcomePageMainDiv">
                               <div class="col-lg-10">
                                  ...
                                  <ol class="breadcrumb">
                                      ...
                                      <li class="active">
                                      	<a href="historical_pieces_specimens_reports_disposed_of.php"><strong>Date Disposed Of</strong></a>
                                      </li>
                                  </ol>
                               </div><!-- /.col-lg-10 -->
                              </div><!-- /.row -->
						...
						<div class="row">
                            ...
                            ?>
                                  <div class="ibox-title">
                                	<h4>Year Disposed Of <b><?php echo $searched_year; ?></b> - <?php echo $result_year_num_rows; ?> Results Found <button onclick="new_report_search()" class="btn btn-blue-new pull-right" style="vertical-align: middle; padding: 1px; width: 150px">New Report Year <i class="glyphicon glyphicon-search"></i></button></h4>
                                  </div>
                                  <?php 
									...
									<div class="col-lg-6 col-md-offset-3">
                                      <form role="form" id="search_prosections" action="" method="POST">
                                          <div class="input-group custom-search-form" style="margin-top:15%">
                                              <input type="number" id="report_year_search_box" name="report_year_search_box" class="form-control" placeholder="Enter Year to Search - Date Disposed Of">
	...
	function new_report_search() {
		window.location = "historical_pieces_specimens_reports_disposed_of.php";
	}
