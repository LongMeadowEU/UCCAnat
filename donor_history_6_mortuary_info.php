...
while ($record = mysqli_fetch_assoc($result)) {
    ...
    } else if (mysqli_num_rows($does_subject_have_prosection) == 1) {
...
if (empty($_POST) === false) {
    ...
    if ($_POST['save_new_info_pg6']) {
        ...
        if ($is_doc_cert_received == "1") {
            ...
            mysqli_query($db_connect, "UPDATE donor_table SET proposed_use = '$new_proposed_use' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET student_permission = '$new_student_permission' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET academic_year = '$new_academic_year' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET student_notes = '$new_student_notes' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            ...
            mysqli_query($db_connect, "UPDATE donor_table SET num_prosections_taken = '$new_num_prosections_taken' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET prosection_number = '$new_prosection_number' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET prosection_title = '$new_prosection_title' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET prosection_unit_rack_number = '$new_prosection_unit_rack_number' WHERE donor_reference_number = '$selected_donor_ref_hist'");
            mysqli_query($db_connect, "UPDATE donor_table SET prosection_store_location = '$new_prosection_store_location' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        }


        // update the correct row for the new patient info added on page 1 of the form with the new changes
        mysqli_query($db_connect, "UPDATE donor_table SET subject_number = '$new_mort_subject_number' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET mort_age = '$new_mort_age' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET sex = '$new_mort_sex' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET unit_rack_number = '$new_unit_rack_number' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        ...
        mysqli_query($db_connect, "UPDATE donor_table SET embalming = '$new_embalming' WHERE donor_reference_number = '$selected_donor_ref_hist'");
        mysqli_query($db_connect, "UPDATE donor_table SET mort_notes = '$new_mort_notes' WHERE donor_reference_number = '$selected_donor_ref_hist'");
                                        ...
                                        <table id="undertakertable" class="centred_text add_patient_table">
                                            ...
                                            <tr class="undertakerInfo">
                                                ...
                                                <td class="formInput">
                                                    <label class="radio-inline">
                                                        <?php
                                                        if ($permission_to_retain_parts == "1") {
                                                    ...
                                                    <label class="radio-inline">
                                                        <?php
                                                        if ($permission_to_retain_parts == "0") {
