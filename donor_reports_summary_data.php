        ...
        <div id="wrapper">
            ...
            if (empty($_POST) === false) {
                if ($_POST['report_year_search_box_summary_data']) {
                    ...
                    $result_year_sum_data = mysqli_query($db_connect, "SELECT * FROM  donor_table WHERE YEAR(date_of_donation) LIKE '%$searched_year_sum_data%' ") or die($connect_error1);
                    $result_year_sum_data_num_rows_sum_data = mysqli_num_rows($result_year_sum_data);

                    $result_year_sum_data_1 = mysqli_query($db_connect, "SELECT * FROM  donor_table WHERE YEAR(date_of_receipt) LIKE '%$searched_year_sum_data%' ") or die($connect_error1);
                    $result_year_sum_data_num_rows_sum_data_1 = mysqli_num_rows($result_year_sum_data_1);

                    $result_year_sum_data_2 = mysqli_query($db_connect, "SELECT * FROM  donor_table WHERE YEAR(consent_withdrawl_date) LIKE '%$searched_year_sum_data%' ") or die($connect_error1);
                    $result_year_sum_data_num_rows_sum_data_2 = mysqli_num_rows($result_year_sum_data_2);

                    //$result_year_sum_data_not_accepted = mysqli_query($db_connect,"SELECT * FROM  donor_table WHERE YEAR(consent_withdrawl_date) LIKE '%$searched_year_sum_data%' ") or die($connect_error1);
                    //$num_donors_not_accepted = mysqli_num_rows($result_year_sum_data_not_accepted);
                }
            }
            ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if ($show_form_summary_data == true) {
                            ...
                            <?php
                            if (mysqli_num_rows($result_year_sum_data) > 0) {
                                ?>
