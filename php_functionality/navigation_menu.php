...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
            ...
            <ul class="nav navbar-top-links navbar-right" id="notification_link" >
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a href="my_profile.php"><i class="fa fa-user fa-fw"></i> User Profile</a>
							</li>
			...
			<li>
                            <a href="dashboard.php"><i class="fa fa-home fa-fw"></i> Donor Progam Home</a>
                        </li>
						</li>
			<li>
                            <a href="donors_table.php"><i class="fa fa-list-ol fa-fw"></i> List of Donors</a>
                        </li>
						<li>
						  <a href="#"><i class="fa fa-history fa-fw"></i>Donor History <span class="fa arrow"></span></a>
						  <ul class="nav nav-third-level">
							  <li>
								  <a href="donor_history_1_general_information.php">General Information</a>
							  </li>
							  <li>
								  <a href="donor_history_2_contact_details.php">Contact Details</a>
							  </li>
							  <li>
								  <a href="donor_history_3_burial_witness_info.php">Burial and Witness Information</a>
							  </li>
							  <li>
								  <a href="donor_history_4_medical_history.php">Medical History</a>
							  </li>
							  <li>
								  <a href="donor_history_7_consent_info.php">Consent Information</a>
							  </li>
							  <li>
								  <a href="donor_history_5_donor_receipt_details.php">Donor Receipt Details</a>
							  </li>
							  <li>
								  <a href="donor_history_6_mortuary_info.php">Mortuary Information</a>
							  </li>
						  </ul>
						  <!-- /.nav-third-level -->
						</li>
			...
			<li>
                            <a href="add_donor_page1.php"><i class="fa fa-plus fa-fw"></i> Add a Donor</a>
                        </li>
						</li>
			<li>
                            <a href="search_for_donor.php"><i class="fa fa-search fa-fw"></i> Search for a Donor</a>
                        </li>
						</li>
			<li>
                            <a href="time_of_death.php"><i class="fa fa-ambulance fa-fw"></i> Time of Death</a>
                        </li>
						<li>
						  <a href="#"><i class="fa fa-newspaper-o fa-fw"></i> Reports</span></a>
						  <ul class="nav nav-third-level">
						  	 <li>
								  <a href="donor_reports.php">Donors Received in Year</a>
							  </li>
							   <li>
								  <a href="donor_reports_released.php">Donors Released in Year</a>
							  </li>
							  <li>
								  <a href="donor_reports_summary_data.php">Summary Data</a>
							  </li>
							  <li>
								  <a href="donor_reports_removals.php">Removals</a>
							  </li>
							</ul>
						</li>
