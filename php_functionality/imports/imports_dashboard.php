<?php
    ...
    $login = $_SESSION['user_id_imports'];
									...
									<div class="row">
										<div class="centred_text">
											...
											<div class="col-lg-4 col-md-4">
												<a href="add_donor_imports.php">
													<img src="images/add_a_specimen_icon.png" class="image_ani_dash tour-step tour-step-three" alt="Add a speciment icon."/>
												</a>
											</div>
											<div class="col-lg-4 col-md-4">
												<a href="search_for_donor_imports.php">
													<img src="images/search_a_specimen_icon.png" class="image_ani_dash tour-step tour-step-four" alt="Search for a specimen icon."/>
												</a>
											</div>
                <!-- /.row -->
            </div>
