...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
            ...
            <ul class="nav navbar-top-links navbar-right" id="notification_link" >
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-user">
							<li><a href="logout_imports.php"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
							</li>
						</ul>
						<!-- /.dropdown-user -->
					</li>
			...
			<li>
                            <a href="imports_home.php"><i class="fa fa-home fa-fw"></i> Imports Home</a>
                        </li>
						</li>
			<li>
                            <a href="add_donor_imports.php"><i class="fa fa-plus fa-fw"></i> Add a Specimen</a>
                        </li>
						</li>
			<li>
                            <a href="search_for_donor_imports.php"><i class="fa fa-search fa-fw"></i> Search for a Specimen</a>
                        </li>
						</li>
			<li>
                            <a href="specimen_list_table.php"><i class="fa fa-list fa-fw"></i> Specimen List</a>
                        </li>
						</li>
			<li>
                            <a href="specimen_history_edit_import.php"><i class="fa fa-pencil fa-fw"></i> Edit a Specimen</a>
                        </li>
			<li>
                            <a href="import_specimens_reports.php"><i class="fa fa-newspaper-o fa-fw"></i> Reports</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
